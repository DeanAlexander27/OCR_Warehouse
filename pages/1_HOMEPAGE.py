...
tab1.title("Welcome to Application WareOCR")
tab1.header("In this tool will help you to reduce manual activities of input important information of documents")
tab2.header("WareOCR is a program to capture infromation of important documents")
...
tab2.write("Here is our flow process using program WareOCR")
